...
| ↳ [추론 지연 실험](05_libero/latency/README.md) | 0.5초 지연에 무너짐, RTC 는 지연 대응용 | - | - | ✅ |
| ↳ [학습 없는 전략 rtc·bon](05_libero/training_free/) | 둘 다 flush 를 못 넘음 | - | - | ✅ |
| ↳ [가설 검증](05_libero/hypothesis_check/README.md) | 팔 위치가 전환 성공을 가르나 → 아니었음 | - | - | ✅ |
