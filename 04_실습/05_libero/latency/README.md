...
|---|---|---|---|
| GPU 공유 중 (다른 평가 2개 실행) | 1281ms (p90 1357ms) | **약 26 스텝 (1.3초)** | 21.6ms |
| GPU 단독 | 측정 대기 중 | - | - |

공유 상태 수치는 부풀려졌지만, **1080 Ti 에서 여러 작업을 같이 돌리면 1초 넘는 지연이 실제로 생긴다**는 뜻입니다. 이 경우 위 표의 "1초" 줄(성공률 0~8%)에 해당합니다.
